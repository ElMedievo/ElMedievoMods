...
content = {}
with open(os.path.join("..", "elmedievo_mods_app", "version.py")) as f:
    exec(f.read(), content)
  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'OriginalFilename', u'ElMedievo Mods'),
        StringStruct(u'ProductName', u'ElMedievo Mods'),
